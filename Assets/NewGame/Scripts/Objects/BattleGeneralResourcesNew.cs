...
public class BattleGeneralResourcesNew {
	...
	public BattleGeneralResourcesNew(BattleGeneralResources clone){
		this.clone(clone);
	}
	...
	public BattleGeneralResourcesNew(int instanceID, List<GameObject> army){
		fill (instanceID, army);
	}
