...
//		BattleSerializeableArmy[] army_2 = new BattleSerializeableArmy[3];
...
//		army_2[1].qty = 150;
//		army_2[2] = new BattleSerializeableArmy ();
//		army_2[2].name = "Necropolis_Zombie";
//		army_2[2].qty = 400;
//		battle[1].army = JsonHelper.ToJson(army_2);
		...
		stats_1.range = 1;
		battle[0].stats = JsonUtility.ToJson(stats_1);
		BattleSerializeableArmy[] army_1 = new BattleSerializeableArmy[4];
		army_1[0] = new BattleSerializeableArmy ();
		army_1[0].name = "Human_Peasant";
		army_1[0].qty = 600;
		army_1[1] = new BattleSerializeableArmy ();
		...
		army_1[2].name = "Human_Princess";
		army_1[2].qty = 200;
		army_1[3] = new BattleSerializeableArmy ();
		army_1[3].name = "Human_Rogue";
		army_1[3].qty = 400;
		battle[0].army = JsonHelper.ToJson(army_1);

		battle[1] = new BattleSerializeable ();
		battle[1].name = "Bumblefreid";
		BattleSerializeableStats stats_2 = new BattleSerializeableStats ();
		stats_2.attack = 1;
		stats_2.defense = 100;
		stats_2.speed = 1;
		...
		BattleSerializeableArmy[] army_2 = new BattleSerializeableArmy[4];
		army_2[0] = new BattleSerializeableArmy ();
		army_2[0].name = "Gnome_Champion";
		army_2[0].qty = 50;
		army_2[1] = new BattleSerializeableArmy ();
		army_2[1].name = "Gnome_Druid";
		army_2[1].qty = 250;
		army_2[2] = new BattleSerializeableArmy ();
		army_2[2].name = "Gnome_Orc";
		army_2[2].qty = 1000;
		army_2[3] = new BattleSerializeableArmy ();
		army_2[3].name = "Gnome_BattleMaster";
		army_2[3].qty = 60;
		battle[1].army = JsonHelper.ToJson(army_2);
